...
# cook_spinach cut_roasted_beef flame_salmon_1 flame_steak sear_steak

RESULT_DIR="results/stg_neu3d_compression_sim_entropy_debug"
...
do
    ...
    CUDA_VISIBLE_DEVICES=2 python simple_trainer_STG.py compression_sim \
        --model_path $RESULT_DIR/$SCENE/ \
        --data_dir $SCENE_DIR/$SCENE/colmap_0 \
        --result_dir $RESULT_DIR/$SCENE/ \
        --duration $NUM_FRAME \
        --entropy_model_opt \
        --profiler_enabled --max_steps 30
