...
class SOM_Strategy(Strategy):
    ...
    prune_opa: float = 0.005 # 0.0025 # 0.005
    grow_grad2d: float = 0.0002 # 0.0001 # 0.0002
    ...
    def step_pre_backward(
        ...
        info[self.key_for_gradient].retain_grad() # 保存info['means2d']的梯度，目的是什么？
    ...
    def step_post_backward(
        ...
        flag_num_change = True
        n_dupli = 0; n_split = 0; n_prune = 0
        ...
        if n_dupli == 0 and n_split == 0 and n_prune == 0:
            flag_num_change = False
        
        return flag_num_change
    ...
    def _prune_gs(
        ...
        if step > self.reset_every:
            ...
            # Disable scale mask TODO STG的确prune时没有考虑scale大小，但是原版3DGS是考虑了的，这里直接禁用scale判断不一定有道理
